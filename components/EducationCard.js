  ...
  return (
    ...
    >
      ...
      <div className="relative rounded-2xl  pb-4 ">
        ...
        <AcademicCapIcon className='h-14 w-14  opacity-80' />
          <p>
          <span className='text-[#5F8D4E] text-base font-bold'> {resource.degree} ( {resource.duration} )</span> 
          <div className='text-sm'>{resource.institution}</div>
          </p>
        </h3>
